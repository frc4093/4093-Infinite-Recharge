...
public class TurnToGyroAngle extends Command {
    ...
    protected void execute() {
        extraSpeed = ((m_angle-Robot.drive.getAngle())/360)*.65;
        if (Robot.drive.getAngle() > m_angle+offset || Robot.drive.getAngle() < m_angle-offset ){
            count = 0; //reset count
            if (m_angle>Robot.drive.getAngle()){
