 ...
 */
public class AutomatedShoot extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutomatedShoot() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
        addSequential(new initialSpeedUpDone()); //make sure we already sped up earlier
        addSequential(new PrepareBallForShoot(false)); //prepare for shot(wont run if ready)
       ...
       addSequential(new pauseShoot(.1));
    } 
}
