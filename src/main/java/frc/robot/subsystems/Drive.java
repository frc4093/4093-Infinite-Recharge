...
public class Drive extends Subsystem {
    ...
    private static final double kDriveEncoderToFt = (1.0/2048)*(1/10)*(6*Math.PI)/12; //1rotation/encoder ticks(2048)*gear ratio(1/10)*wheel diameter*PI/12 in
...
drive.setMaxOutput(1.0);
    ...
    public double getDriveFPS(TalonFX motor){
        /**
         * what the math does
         * converts motor velocity per 100ms to per second
         * divides by units per encoder rotation
         * multiplys by circumference(π*wheel diameter)
        */
        return ( ((motor.getSelectedSensorVelocity() * 10)
        / kSensorUnitsPerRotation)*(Math.PI*kWheelDiameter));
    }
    public void calGyro(){
        imu.calibrate();
    }
