...
public class Limelight extends Subsystem {
    ...
    //for distance
    private final double a1 = 36; //mounting angle of camera
    private double a2 = 0; //y angle will grab from method
    private final double h1 = 15.5; //height of camera above floor
    private final double h2 = 100; //height of target
