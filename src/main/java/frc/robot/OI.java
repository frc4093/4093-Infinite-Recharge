...
joystickButton3 = new JoystickButton(operatorGamepad, 2);
joystickButton3.whileHeld(new Shoot());
intakeButton = new JoystickButton(operatorGamepad, 1);
intakeButton.whileHeld(new Run_Intake());
driveGamepad = new Joystick(0);

joystickButton2 = new JoystickButton(driveGamepad, 2);
joystickButton2.whileHeld(new AutoAlign());
joystickButton1 = new JoystickButton(driveGamepad, 1);
