...
joystickButton2.whileHeld(new AutoAlign());
        ...
        SmartDashboard.putData("Manual_Index", new Manual_Index());
        SmartDashboard.putData("passAutoLine", new passAutoLine());
        SmartDashboard.putData("6BallAutoLT", new 6BallAutoLT());
        SmartDashboard.putData("TargetPosAuto", new TargetPosAuto());
        SmartDashboard.putData("6BallAutoRT", new 6BallAutoRT());
