...
startShooterRB.whenPressed(new startShooterDistanceGroup());
...
startIntakedriver.whenPressed(new AutomatedIntake());
...
bButtonAutoAlign.whileHeld(new AutoAlign());
        ...
        SmartDashboard.putData("Start_Shooter", new Start_Shooter(false));
